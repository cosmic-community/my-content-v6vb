(function() {
  ...
  if (document.readyState === 'complete') {
    ...
    window.addEventListener('load', function() { sendReady(); sendRouteChange(); });
  }
  
  const originalPushState = history.pushState;
  const originalReplaceState = history.replaceState;
  history.pushState = function() { originalPushState.apply(history, arguments); sendRouteChange(); };
  history.replaceState = function() { originalReplaceState.apply(history, arguments); sendRouteChange(); };
